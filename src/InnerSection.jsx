        ...
        <div className="relative p-4 w-full max-w-xl mx-auto h-full md:h-auto">
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="flex gap-2 p-5">
              ...
              <button className="px-3 py-1 rounded-full flex items-center gap-2 hover:bg-[#EBEBEB]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 16 16"
                  data-supported-dps="16x16"
                  ...
                  focusable="false"
                >
                  <path d="M5 8h5v1H5zm11-.5v.08a6 6 0 01-2.75 5L8 16v-3H5.5A5.51 5.51 0 010 7.5 5.62 5.62 0 015.74 2h4.76A5.5 5.5 0 0116 7.5zm-2 0A3.5 3.5 0 0010.5 4H5.74A3.62 3.62 0 002 7.5 3.53 3.53 0 005.5 11H10v1.33l2.17-1.39A4 4 0 0014 7.58zM5 7h6V6H5z" fill="#5E5E5E"></path>
                </svg>
                <span>Anyone</span>
              </button>

              <button className="px-4 py-1 rounded-full flex items-center gap-2 font-medium text-[#A4A4A4] hover:text-[#ffff] bg-[#EBEBEB] hover:bg-[#0A66C2]">Post</button>
            </div>
          </div>
        </div>
      </div>
