  ...
  return (
    <div className="container max-w-xl border-2 rounded-lg bg-[#fff] md:mr-10">
      ...
      <div className="flex px-4">
        <div className="px-4">
          <button className="flex px-2 py-4 gap-3 items-center rounded-lg hover:bg-gray-100">
            <svg
        ...
        <div className="px-4">
          <button className="flex px-2 py-4 gap-3 items-center rounded-lg hover:bg-gray-100">
            <svg
              ...
              focusable="false"
            >
              <path d="M21 3v2H3V3zm-6 6h6V7h-6zm0 4h6v-2h-6zm0 4h6v-2h-6zM3 21h18v-2H3zM13 7H3v10h10z" fill="#FF4500"></path>
            </svg>
            Write article
          </button>
        </div>
