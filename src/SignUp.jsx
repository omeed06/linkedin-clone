...
const SignUp = () => {
  ...
  return (
    <div className="bg-[#F3F2EF] min-h-[calc(100vh)]">
      <div className="p-20">
        <a class="linkedin-logo" href="/" aria-label="Linkedin" className="">
          <li-icon
            tabindex="0"
            aria-label="LinkedIn"
            type="linkedin-logo"
      ...
      <div className="rounded-lg shadow-sm-light container max-w-sm bg-[#ffffff] mx-auto mt-5">
        ...
        <div className="px-4 py-2">
          ...
          <div className="flex justify-end items-center">
            <input
              ...
              id=""
              placeholder=""
              className="rounded-md min-w-full relative"
            />
            <span
              onClick={() => setShowPassword(!showPassword)}
              className="absolute px-2 hover:border hover:outline-1 hover:rounded-full hover:bg-[#98d8f473] font-medium text-[#0073b1] mx-1"
            >
        ...
        <div className="mx-4 my-2">
          <p className="text-center text-xs">
            ...
            <span className="hover:underline cursor-pointer text-[#2874CB]">
              User Agreement
            </span>
            ,{" "}
            <span className="hover:underline cursor-pointer text-[#2874CB]">
        ...
        <div className="mx-4 my-2">
          <button className="border outline-1 px-2 py-2 rounded-full bg-[#0073b1] text-white min-w-full font-medium text-lg">
            Agree & Join
          </button>
        </div>

        <div className="flex flex-row justify-center items-center gap-2 mx-4 my-4">
          <div className="border-t-[1px] border-gray-200 w-2/4 "></div>
          <p>or</p>
          <div className="border-b-[1px] border-gray-200 w-2/4"></div>
        </div>

        <div className="mx-4 my-2">
          <div className="py-2">
            <button className="min-w-full px-2 py-2 rounded-full border-slate-600 hover:bg-[#F3F3F3] border flex gap-2 justify-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="22"
                height="24"
        ...
        <div className="flex justify-center items-center pb-5">
          ...
          <button className="px-2 py-1 rounded-full text-[#0A66C2] font-medium hover:underline cursor-pointer">
      ...
      <div className="flex justify-center items-center pt-5">
          <p className="text-sm">Looking to create a page for a business?</p>
          <button className="px-2 py-1 rounded-full text-[#0A66C2] font-medium hover:underline cursor-pointer text-sm">
          Get help
          </button>
        </div>
    </div>
